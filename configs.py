...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/nbzoning")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/OkaeriUserbot")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Wahyu213/Okaeri")
